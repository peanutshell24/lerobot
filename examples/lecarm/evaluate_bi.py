...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Lecarm Robot with a pretrained policy")
    ...
    parser.add_argument("--remote_ip", type=str, default="192.168.1.21", help="lecarm host IP address")
    parser.add_argument("--robot_id", type=str, default="lecarm", help="Robot ID")
    ...
    init_rerun(session_name="lecarm_evaluate")
